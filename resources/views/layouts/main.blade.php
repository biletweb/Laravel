<!doctype html>
<html lang="en" @if(date('H:i') > '21:59' and date('H:i') < '05:59') data-bs-theme="dark" @else data-bs-theme="light" @endif>
<head>
    <meta charset="UTF-8">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="text-end ms-5">
                            <a class="btn btn-outline-primary me-1" href="#" role="button">{{ __('Login') }}</a>
                            <a class="btn btn-outline-primary" href="#" role="button">{{ __('Sign-up') }}</a>
                        </div>
                    </div>
                </div>
            </nav>
        ...
        <div class="col">
            <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                ...
                <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
                    <li class="me-2"><a class="text-body-secondary" href="#" title="Telegram">
                    ...
                    <li class="me-2"><a class="text-body-secondary" href="#" title="Facebook">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                            </svg>
                        </a>
                    </li>
                    <li class="me-2"><a class="text-body-secondary" href="#" title="Twitter">
